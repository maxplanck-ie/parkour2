Ext.define("MainHub.view.statisticsvue.RunStatisticsVue", {
  extend: "Ext.container.Container",
  xtype: "run-statistics-vue",

  layout: "fit",
  iframeDomId: "runStatisticsIframe",
  ...
  addIframe: function () {
    this.add({
      ...
      html:
        ...
        '/vue/run_statistics" width="100%" height="100%" frameborder="0"></iframe>'
    });
  },
