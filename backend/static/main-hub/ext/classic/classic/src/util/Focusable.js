  ...
  "Ext.util.Focusable",
  {
    ...
    privates: {
      ...
      revertFocus: function () {
        ...
        if (
          me.preventRefocus ||
          !me.el.contains(Ext.Element.getActiveElement()) ||
          !focusEvent
        ) {
          return;
        }
        ...
        if (
          Ext.getDoc().contains(focusTarget) &&
      ...
      findFocusTarget: function () {
        ...
        for (
          owner = me.up(":visible(true):not([disabled]):not([destroying])");
          owner;
          owner = owner.up(":visible(true):not([disabled]):not([destroying])")
        ) {
