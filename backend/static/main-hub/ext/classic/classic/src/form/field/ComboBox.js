...
Ext.define("Ext.form.field.ComboBox", {
  ...
  doQuery: function (queryString, forceAll, rawQuery) {
    ...
    if (queryPlan !== false && !queryPlan.cancel) {
      ...
      refreshFilters =
        !!queryString &&
        (!me.queryFilter ||
          (me.queryFilter && filters.indexOf(me.queryFilter) < 0));
  ...
  doTypeAhead: function (queryPlan) {
    ...
    if (
      queryPlan.query.length > queryPlan.lastQuery.length ||
  ...
  setValue: function (value) {
    ...
    if (me.hasFocus) {
      ...
      if (valueBind && valueBind.syncing) {
        if (
          (Ext.isEmpty(value) && Ext.isEmpty(me.value)) ||
          value === me.value
        ) {
          return me;
        } else if (
          Ext.isArray(value) &&
          Ext.isArray(me.value) &&
