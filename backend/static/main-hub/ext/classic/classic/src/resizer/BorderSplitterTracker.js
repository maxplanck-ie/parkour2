...
Ext.define("Ext.resizer.BorderSplitterTracker", {
  ...
  calculateConstrainRegion: function () {
    ...
    minRange =
      (collapseTarget[minSizeProp] || Math.min(size, defaultSplitMin)) - size;
    ...
    for (i = 0; i < length; ++i) {
      ...
      maxShrink =
        size - (neighbor[minSizeProp] || Math.min(size, defaultSplitMin));
    ...
    me.constraintAdjusters[me.getCollapseDirection()](
      box,
      minRange,
      maxRange,
      splitter,
