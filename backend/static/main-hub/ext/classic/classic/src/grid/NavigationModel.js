...
Ext.define("Ext.grid.NavigationModel", {
  ...
  onCellMouseDown: function (
    ...
    var targetComponent = Ext.Component.fromElement(
      ...
      onActionable =
        targetEl.isFocusable() && !targetEl.is(view.getCellSelector()),
      ac;
  ...
  onCellClick: function (
    ...
    if (
      !Ext.isIE10m &&
      !view.el.contains(Ext.Element.getActiveElement()) &&
  ...
  onFocusMove: function (e) {
    ...
    if (view) {
      ...
      if (!view.actionableMode && isCell) {
        ...
        (view.actionableMode || view.activating) &&
        !isCell &&
        view.el.contains(e.target) &&
        view.el.dom !== e.target
      ) {
  ...
  onItemMouseDown: function (view, record, item, index, mousedownEvent) {
    ...
    if (
      ...
      mousedownEvent.pointerType !== "touch"
    ) {
  ...
  move: function (dir, keyEvent) {
    ...
    if (position && position.record) {
      while (result) {
        ...
        result = position.view.walkCells(
          result,
          dir,
