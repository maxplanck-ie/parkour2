...
Ext.define("Ext.grid.feature.Grouping", {
  ...
  setupRowData: function (record, idx, rowValues) {
    var me = this,
      ...
      // See EXTJS-18655.
      group =
        record.isCollapsedPlaceholder && Ext.isDefined(groupKey)
  ...
  setup: function (rows, rowValues) {
    ...
    if (bufferedRenderer) {
      bufferedRenderer.variableRowHeight =
        view.hasVariableRowHeight() || isGrouping;
    }
  ...
  privates: {
    ...
    didColumnsChange: function () {
      var me = this,
        result =
          me.view.headerCt.items.generation !== me.lastHeaderCtGeneration;
