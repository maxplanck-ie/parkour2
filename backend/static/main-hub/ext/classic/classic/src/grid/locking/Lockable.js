...
Ext.define(
  "Ext.grid.locking.Lockable",
  {
    ...
    onBeginLockedFloat: function (locked) {
      ...
      locked.body.dom.style.overflowX = this.normalGrid.headerCt.tooNarrow
        ? "scroll"
        : "";
    ...
    beforeLayout: function () {
      ...
      if (lockedGrid && normalGrid) {
        ...
        if (
          !lockedGrid.layoutCounter &&
          lockedGrid.getSizeModel().width.shrinkWrap
        ) {
    ...
    syncLockableLayout: function () {
      ...
      if (!me.isCollapsingOrExpanding && lockedGrid && normalGrid) {
        ...
        lockedViewRegion = lockedGridVisible
          ? lockedGrid.body.getRegion(true)
          : new Ext.util.Region(0, 0, 0, 0);
        normalViewRegion = normalGridVisible
          ? normalGrid.body.getRegion(true)
          : new Ext.util.Region(0, 0, 0, 0);
        ...
        normalViewX = lockedGridVisible
          ? normalViewRegion.x - lockedViewRegion.x
          : 0;
        hasHorizontalScrollbar =
          normalGrid.headerCt.tooNarrow || lockedGrid.headerCt.tooNarrow
            ? scrollbarHeight
            : 0;
    ...
    initScrollContainer: function () {
      var me = this,
        ...
        normalScrollbarScroller,
        lockedScrollbarClipper,
