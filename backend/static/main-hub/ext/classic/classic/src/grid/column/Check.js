...
Ext.define("Ext.grid.column.Check", {
  ...
  updater: function (cell, value) {
    ...
    Ext.fly(cell.down(me.getView().innerSelector, true).firstChild)[
    ...
    afterText: function (out, values) {
      ...
      if (me.useAriaElements) {
        out.push(
          '<span id="' +
            id +
            '-header-description-selected" class="' +
            Ext.baseCSSPrefix +
            'hidden-offsets">' +
            me.headerDeselectText +
            "</span>" +
            '<span id="' +
            id +
            '-header-description-not-selected" class="' +
            Ext.baseCSSPrefix +
            'hidden-offsets">' +
            me.headerSelectText +
            "</span>" +
            '<span id="' +
            id +
            '-cell-description-selected" class="' +
            Ext.baseCSSPrefix +
            'hidden-offsets">' +
            me.rowDeselectText +
            "</span>" +
            '<span id="' +
            id +
            '-cell-description-not-selected" class="' +
            Ext.baseCSSPrefix +
            'hidden-offsets">' +
            me.rowSelectText +
            "</span>"
