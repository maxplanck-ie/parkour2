...
Ext.define(
  "Ext.panel.Panel",
  {
    ...
    onMouseLeaveFloated: function (e) {
      ...
      if (
        toElement &&
        (this.owns(toElement) || this.placeholder.owns(toElement))
      ) {
        return;
      }
    ...
    initRenderData: function () {
      ...
      if (bodyWrapRole) {
        ...
        if (
          !me.ariaStaticRoles[bodyWrapRole] &&
    ...
    navigateAccordionHeader: function (e) {
      ...
      switch (key) {
        ...
        case e.DELETE:
          target =
            me.findAccordionSibling("prev") || me.findAccordionSibling("next");
    ...
    canFocus: function (skipVisibility, includeFocusTarget) {
      ...
      if (this.collapsed) {
        return !!(
          this.placeholder &&
          this.placeholder.canFocus(skipVisibility, includeFocusTarget)
        );
      }
