...
Ext.define("Ext.panel.Table", {
  ...
  initComponent: function () {
    ...
    // Not lockable - create the HeaderContainer
      ...
      // It's an array of Column definitions, or a config object of a HeaderContainer
        ...
        me.headerCt = headerCt = new Ext.grid.header.Container(
  ...
  createManagedWidget: function (ownerId, widgetConfig, record) {
    return this.liveRowContexts[record.internalId].getWidget(
      ownerId,
      widgetConfig
    );
  },
  ...
  getView: function () {
    ...
    if (!me.view) {
      ...
      if (
        !(
          "scrollable" in viewConfig ||
          "scroll" in viewConfig ||
          "autoScroll" in viewConfig
        ) &&
        scrollable != null
      ) {
