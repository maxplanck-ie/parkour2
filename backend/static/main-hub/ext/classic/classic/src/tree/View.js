...
Ext.define("Ext.tree.View", {
  ...
  onCellClick: function (cell, cellIndex, record, row, rowIndex, e) {
    ...
    if (column.isTreeColumn) {
      ...
      if (
        e.getTarget(me.checkboxSelector, cell) &&
        record.get("checked") != null
      ) {
        me.onCheckChange(e);
      ...
      // Click on the expander
        ...
        e.getTarget(me.expanderSelector, cell) &&
        record.isExpandable()
      ) {
  ...
  setChecked: function (record, meChecked, e, options) {
    var me = this,
      ...
      progagateCheck =
        (!options || options.propagateCheck !== false) && checkPropagation & 1,
      checkParent =
        (!options || options.checkParent !== false) && checkPropagation & 2,
      parentNode,
      parentChecked,
      foundCheck,
      foundClear,
