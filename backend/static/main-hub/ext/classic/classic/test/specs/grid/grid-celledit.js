      ...
      function () {
        ...
        function tabAndWaitFor(x, y) {
          ...
          waitsFor(
            function () {
              return (
                activeEditor.el.dom.parentNode === Ext.getDetachedBody().dom &&
                isEditing(x, y)
              );
            },
            "move to cell " + x + "," + y + "",
        ...
        describe("basic editing", function () {
          ...
          (buffered ? it : xit)(
            "should cancel editing on de-rendering a row",
            function () {
              var data = [],
                i,
                editorEl;
          ...
          function makeCleanupSuite(withLocking) {
            describe(
              ...
              function () {
                ...
                describe(
                  "not activated " +
                    (withLocking ? "with locking" : "with no locking"),
                  function () {
            ...
            it("should prevent editing if false is returned from the CellEditor's beforestartedit event", function () {
              ...
              runs(function () {
                plugin
                  ...
                  .on("beforestartedit", function (editor) {
                    // Only allow editing on rows other than the first
                    called = true;
          ...
          it("should move the editor when a column is locked", function () {
            ...
            waitsFor(function () {
              ...
              return (
                ...
                activeEditor.el.dom.parentNode === context.cell
              );
        ...
        describe("key handling", function () {
          ...
          it("should navigate to the other side when tabbing at a locking boundary", function () {
            ...
            waitsFor(function () {
              return (
                plugin.getActiveEditor().context.view === grid.normalGrid.view
              );
            });
            runs(function () {
        ...
        describe("Autorepeat TAB in ungrouped grid", function () {
          ...
          webkitIt(
            "should not lose track of editing position during repeated tabbing with a refresh on edit",
            function () {
          ...
          webkitIt(
            "should not lose track of editing position during repeated tabbing with a store reload on edit",
            function () {
              // Throw in a refresh on each edit
              grid.on({
                edit: function () {
          ...
          webkitIt(
            "should not lose track of editing position during repeated tabbing with a store reload to fewer rows than the edit row on edit",
            function () {
          ...
          webkitIt(
            "should fire editor events in the correct order",
            function () {
              var calls = [];
              grid.on({
