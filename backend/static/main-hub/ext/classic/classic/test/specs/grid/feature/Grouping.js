    ...
    describe("init", function () {
      describe("startCollapsed", function () {
        function makeStartCollapsed(startCollapsed, isBR) {
          it(
            "should honor the `startCollapsed` config when " +
              (startCollapsed
                ? "starting collapsed, "
                : "starting expanded, ") +
              (isBR ? "buffer rendered" : "non buffer rendered"),
            function () {
        ...
        function collapsed(collapseState, filterValue) {
          it(
            "should retain its collapsed state of " +
              filterValue +
              " after the grid store is filtered and cleared when " +
        ...
        function testIt(group, method, filterValue) {
          ...
          describe(
            ...
            function () {
              ...
              it(
                "should have the " +
                  (initialState ? "collapseTip" : "expandTip") +
                  " tooltip",
                function () {
                  var row;
                  makeUI(null, {
  ...
  describe("adding new record to group", function () {
    describe("inserting in first position", function () {
      ...
      function doTests(isBR) {
        it(
          "should not create a new group in store, buffered rendering = " +
            isBR,
          function () {
            doTheGrid(isBR);
        ...
        it(
          "should not create a new group in view, buffered rendering = " + isBR,
          function () {
            doTheGrid(isBR);
