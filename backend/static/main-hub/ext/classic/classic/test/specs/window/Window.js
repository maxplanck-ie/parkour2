...
describe("Ext.window.Window", function () {
  ...
  describe("maximize/restore", function () {
    ...
    describe("sizing", function () {
      ...
      (Ext.isIE8 ? xit : it)(
        "should restore to the previous percentage size when configured",
        function () {
          win = new Ext.window.Window({
            width: "60%",
            height: "30%",
  ...
  it("should restore focus after dragging", function () {
    ...
    waitsFor(function () {
      return (
        win.containsFocus && Ext.Element.getActiveElement() === t.inputEl.dom
      );
    });
  ...
  it("should allow click to focus", function () {
    ...
    waitsFor(function () {
      return (
        win.containsFocus &&
        Ext.Element.getActiveElement() === ts[0].inputEl.dom
      );
    });
