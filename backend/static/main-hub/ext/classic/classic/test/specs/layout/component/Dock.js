  ...
  describe("DOM element order", function () {
    ...
    function makeSuite(config, elOrder, wrapOrder, changeFn, desc) {
      ...
      var suiteDesc =
        ...
        (config.title === null
          ? " no header"
          : " header position: " + (config.headerPosition || "left")) +
        (config.dockedItems === null ? " no dockedItems" : " w/ dockedItems") +
        ", frame: " +
        !!config.frame +
        ", tab guards: " +
        (config.tabGuard ? "on" : "off");
    ...
    makeSuite(
      { dockedItems: null, title: null, headerPosition: "top" },
      [0, "bodyWrap"],
      ["body"],
      addHeader,
      "dynamic header 1"
    ...
    makeSuite(
      { dockedItems: null, title: null, tabGuard: true, headerPosition: "top" },
      ["tabGuardBeforeEl", 0, "bodyWrap", "tabGuardAfterEl"],
      ["body"],
      addHeader,
      "dynamic header 5"
    ...
    makeSuite(
      { title: null, tabGuard: true, headerPosition: "top" },
      ["tabGuardBeforeEl", 0, "bodyWrap", "tabGuardAfterEl"],
      [1, 2, 5, 8, "body", 4, 3, 6, 7],
      addHeader,
      "dynamic header 9"
    ...
    // All together now.
    makeSuite(
      { title: null, dockedItems: null, tabGuard: true, headerPosition: "top" },
      ["tabGuardBeforeEl", 0, "bodyWrap", "tabGuardAfterEl"],
      [1, 2, 5, 8, "body", 4, 3, 6, 7],
      addHeaderAndItems,
      "dynamic items 5"
    ...
    if (!Ext.supports.CSS3BorderRadius) {
      ...
      // No header, dockedItems plus tabGuards
      makeSuite(
        { frame: true, title: null, tabGuard: true },
        [
          "tabGuardBeforeEl",
          "frameTL",
          "frameML",
      ...
      // Header position with tab guards and dockedItems
      makeSuite(
        { frame: true, tabGuard: true, headerPosition: "top" },
        [
          "tabGuardBeforeEl",
          0,
          "frameTL",
      ...
      // Header added after rendering
      makeSuite(
        { frame: true, dockedItems: null, title: null, headerPosition: "top" },
        [0, "frameTL", "bodyContainer", "frameBL"],
        ["body"],
        addHeader,
        "dynamic header 1"
      ...
      // Header added after rendering onto existing tab guards and dockedItems
      makeSuite(
        { frame: true, title: null, tabGuard: true, headerPosition: "top" },
        [
          "tabGuardBeforeEl",
          0,
          "frameTL",
