...
describe("Ext.tip.ToolTip", function () {
  ...
  describe("alwaysOnTop", function () {
    var alwaysOnTopWindow, extraWindow, centerWindow, combo;

    afterEach(function () {
      Ext.destroy(alwaysOnTopWindow, extraWindow, centerWindow, combo);
    });
    ...
    it("should move the tooltip to the top above any other alwaysOnTop floater", function () {
      ...
      waitsFor(function () {
        return (
          tip.isVisible(true) && centerWindow.zIndexManager.getActive() === tip
        );
      });
