      ...
      function () {
        ...
        describe("scrollbars", function () {
          beforeEach(function () {
            ...
            Ext.grid.ColumnLayout.prototype.scrollbarWidth = scrollbarsTakeSpace
              ? 20
              : 0;
          });
          ...
          viewHeight =
            singleRowHeight * 21 +
            (Ext.getScrollbarSize().height || singleRowHeight - 5);
          ...
          maxRowsBeforeScrollWithHorizontalScrollBar =
            maxRowsBeforeScroll - (Ext.getScrollbarSize().height ? 1 : 0);
              ...
              function () {
                ...
                function expectScroll(vertical, horizontal) {
                  var scrollView = gridRef.getView(),
                    ...
                    clientHeight = withLocking
                      ? grid.scrollBody.el.dom.clientHeight
                      : dom.clientHeight,
                ...
                describe("header sizing", function () {
                  ...
                  describe("with no vertical and horizontal scroll", function () {
                    visibleScrollbarsIt(
                      "should stretch to the full column size",
                      function () {
                        makeScrollGrid(
                          [
                            {
  ...
  describe("Focus column header after deleting only row", function () {
    ...
    describe("direct focus of internal tabbable element", function () {
      it("should enter actionable mode", function () {
        ...
        waitsFor(function () {
          return (
            Ext.Element.getActiveElement() === icon &&
            grid.actionableMode === true
          );
    ...
    describe("SHIFT+TAB back into grid", function () {
      it("should enter navigable mode on the last cell", function () {
        ...
        waitsFor(function () {
          return (
            grid.getNavigationModel().getPosition().isEqual(cell01) &&
            Ext.Element.getActiveElement() === cell01.getCell(true) &&
            grid.actionableMode !== true
          );
