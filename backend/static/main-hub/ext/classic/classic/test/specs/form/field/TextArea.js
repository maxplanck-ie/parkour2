describe("Ext.form.field.TextArea", function () {
  ...
  (Ext.isIE8 ? xdescribe : describe)(
    "autoSize method and grow configs",
    function () {
        ...
        function () {
          ...
          function makeSideLabelSuite(labelAlign) {
            describe(labelAlign + " label", function () {
              ...
              // TODO: EXTJS-12634
              (Ext.isIE8 ? xit : it)(
                "should layout with hidden side error",
                function () {
                  create({
                    labelAlign: labelAlign,
                    msgTarget: "side"
              ...
              // TODO: EXTJS-12634
              (Ext.isIE8 ? xit : it)(
                "should layout with hidden label",
                function () {
                  create({
                    labelAlign: labelAlign,
                    hideLabel: true
              ...
              // TODO: EXTJS-12634
              (Ext.isIE8 ? xit : it)(
                "should layout with hidden label and side error",
                function () {
                  create({
                    labelAlign: labelAlign,
                    hideLabel: true,
              ...
              // TODO: EXTJS-12634
              (Ext.isIE8 ? xit : it)(
                "should layout with hidden label and hidden side error",
                function () {
                  create({
                    labelAlign: labelAlign,
                    hideLabel: true,
