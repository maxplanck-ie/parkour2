      ...
      function () {
        ...
        function makeGrid(columns, pluginCfg, locked, gridCfg) {
          ...
          scroller = view.getScrollable
            ? view.getScrollable()
            : grid.normalGrid.view.getScrollable();
        }
          ...
          it("it should keep the editor active if scrolling out of view", function () {
            ...
            waitsFor(
              function () {
                view.scrollBy(0, -100);
                return (
                  view.getScrollY() === 0 && plugin.editor.getLocalY() === 0
                );
              },
        ...
        describe("using a textarea as an editor", function () {
          it("should align to the bottom of the editor when at the end", function () {
            ...
            waitsFor(function () {
              return (
                plugin.editor.activeField && plugin.editor.activeField.hasFocus
              );
            });
        ...
        describe("resizing columns", function () {
          it("should keep x scroll synced", function () {
            ...
            waitsFor(function () {
              ...
              return (
                plugin.editor.getScrollable().getPosition().x ===
                scroller.getPosition().x
              );
