describe("Ext.Component", function () {
  ...
  describe("component lookup by element", function () {
    describe("focusable components", function () {
      ...
      it(
        "should add " + compIdAttr + " attribute to the focusable element",
        function () {
      ...
      it(
        "should be able to look Component up by " + compIdAttr + " attribute",
        function () {
    ...
    describe("non-focusable components", function () {
      ...
      it(
        "should not add " + compIdAttr + " attribute to Component's elements",
        function () {
    ...
    function () {
      ...
      it("should call onScrollMove during scrolling", function () {
        ...
        waitsFor(
          ...
          "moveSpy to fire the first time",
          1000,
        );
        ...
        waitsFor(
          ...
          "moveSpy to fire the second time",
          1000,
        );
    ...
    function () {
      ...
      function makeCmpWithTouchAction(touchAction) {
        Cmp = Ext.define(null, {
          ...
          childEls: ["child"],
          renderTpl:
            '<div id="{id}-child" data-ref="child">{%this.renderContent(out,values)%}</div>',
        });
        cmp = new Cmp({
          renderTo: Ext.getBody(),
