...
Ext.define("Ext.drag.Source", {
  ...
  requires: ["Ext.GlobalEvents", "Ext.drag.Constraint"],
  ...
  privates: {
    ...
    canActivateOnLongPress: function (e) {
      ...
      return !!(
        activate &&
        (activate === true || Ext.Array.contains(activate, e.pointerType))
      );
    },
    ...
    preventStart: function (e) {
      return (
        this.isDisabled() || (!e.longpress && this.canActivateOnLongPress(e))
      );
    },
