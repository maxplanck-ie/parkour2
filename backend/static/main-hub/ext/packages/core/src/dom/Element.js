...
Ext.define(
  ...
  function (Element) {
    ...
    TOP.__elementIdCounter = elementIdCounter =
      (TOP.__elementIdCounter__ || 0) + 1;
      ...
      privates: {
        doAddListener: function (
          ...
          if (!me.blockedEvents[eventName]) {
            ...
            if (
              ...
              if (
                me.longpressEvents[eventName] &&
                ++me.longpressListenerCount === 1
              ) {
        ...
        doRemoveListener: function (eventName, fn, scope) {
          ...
          if (!me.blockedEvents[eventName]) {
            ...
            translatedEventName = me.eventMap[eventName];
            if (translatedEventName) {
              removed = observableDoRemoveListener.call(
                me,
                translatedEventName,
                fn,
                scope,
