...
Ext.define("Ext.util.Positionable", {
  ...
  privates: {
    ...
    clipTo: function (clippingEl, sides) {
      ...
      if (
        sides & 1 &&
        (overflow = clippingRegion.top - floaterRegion.top) > 0
      ) {
      ...
      if (
        sides & 2 &&
        (overflow = floaterRegion.right - clippingRegion.right) > 0
      ) {
      ...
      if (
        sides & 4 &&
        (overflow = floaterRegion.bottom - clippingRegion.bottom) > 0
      ) {
      ...
      if (
        sides & 8 &&
        (overflow = clippingRegion.left - floaterRegion.left) > 0
      ) {
