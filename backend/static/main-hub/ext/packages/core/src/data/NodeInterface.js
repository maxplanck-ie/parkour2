      ...
      return {
        ...
        appendChild: function (node, suppressEvents, commit) {
          var me = this,
            ...
            halfCheckedValue =
              treeStore && treeStore.triStateCheckbox ? 1 : false,
          ...
          if (Ext.isArray(node)) {
            ...
            if (
              suppressEvents !== true &&
              me.fireBubbledEvent("beforeappend", [me, node]) === false
            ) {
            ...
            if (oldParent) {
              if (
                suppressEvents !== true &&
                node.fireBubbledEvent("beforemove", [
                  node,
                  oldParent,
                  me,
                  index
        ...
        removeChild: function (node, erase, suppressEvents, isMove) {
          ...
          if (
            index === -1 ||
            (suppressEvents !== true &&
              me.fireBubbledEvent("beforeremove", [me, node, !!isMove]) ===
                false)
          ) {
            return false;
          }
        ...
        insertBefore: function (node, refNode, suppressEvents) {
          ...
          if (
            suppressEvents !== true &&
            me.fireBubbledEvent("beforeinsert", [me, node, refNode]) === false
          ) {
            return false;
          }
