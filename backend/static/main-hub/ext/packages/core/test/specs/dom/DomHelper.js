  ...
  function Ext_core_DomHelper_Tests() {
    ...
    describe("markup", function () {
      ...
      it("should return the markup for an object", function () {
        var markup =
            '<div class="class"><span style="padding:10px;">test</span><br/></div>',
          html = {
            cls: "class",
            children: [
              {
    ...
    describe("overwrite", function () {
      ...
      describe("table innerHTML bug", function () {
        ...
        it("should set the html of a select Element", function () {
          var html =
            '<option>option 1</option><option selected="selected">option 2</option>';
        ...
        it("should set the html of a table Element", function () {
          var html =
            '<tbody><tr><td>cell 1</td><td>cell 2</td></tr><tr><td class="cell">cell 1</td><td>cell 2</td></tr></tbody>';
        ...
        it("should set the html of a tbody Element", function () {
          var html =
            '<tr><td>cell 1</td><td>cell 2</td></tr><tr><td class="cell">cell 1</td><td>cell 2</td></tr>';
        ...
        it("should set the html of a td Element", function () {
          var html =
            '<span class="span">Some Span</span><a href="#">Some Link</a>';
