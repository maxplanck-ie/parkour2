describe("Ext.XTemplate", function () {
  ...
  describe("tags", function () {
    describe("if", function () {
      it("should handle tpl tag with no attributes", function () {
        tpl = new Ext.XTemplate("<tpl>{name}</tpl>");
    ...
    describe("foreach", function () {
      ...
      it("should be able to access the xindex using {#}", function () {
        var tpl = new Ext.XTemplate('<tpl foreach="kids">', "{#}", "</tpl>");
  ...
  describe("template member functions", function () {
    ...
    beforeEach(function () {
      spy = jasmine
        .createSpy("membersArguments")
        .andCallFake(function (value, suffix, limit) {
  ...
  describe("formats", function () {
    ...
    describe("enabled", function () {
      beforeEach(function () {
        tpl = new Ext.XTemplate("{a:ellipsis(2)}");
      });
    ...
    describe("disabled", function () {
      beforeEach(function () {
        tpl = new Ext.XTemplate("{a:ellipsis(2)}", { disableFormats: true });
      });
    ...
    describe("method", function () {
      it("should call a basic method", function () {
        tpl = new Ext.XTemplate("Linkify: {text:this.linkify}", {
          /**
