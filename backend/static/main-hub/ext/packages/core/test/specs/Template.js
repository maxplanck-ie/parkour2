describe("Ext.Template", function () {
  ...
  describe("methods", function () {
    ...
    describe("compile", function () {
      ...
      it("should return the same value as if it wasn't compiled with a complex template", function () {
        var htmlWithNotCompiledTemplate, htmlWithCompiledTemplate;
  ...
  describe("formats", function () {
    var tpl, ellipsisSpy, htmlEncodeSpy, appliedObject;
    ...
    describe("enabled", function () {
      beforeEach(function () {
        tpl = new Ext.Template("{a:ellipsis(2)}", "{b:htmlEncode}");
      });
    ...
    describe("disabled", function () {
      beforeEach(function () {
        tpl = new Ext.Template("{a:ellipsis(2)}", { disableFormats: true });
      });
