...
Ext.define("Ext.ux.Gauge", {
  ...
  centerText: function (cx, cy, sectorRegion, innerRadius, outerRadius) {
    ...
    if (
      Ext.Number.isEqual(innerRadius, 0, 0.1) ||
  ...
  getArcPath: function (
    ...
    var me = this,
      ...
      innerStartPoint = me.getArcPoint(
        centerX,
        centerY,
        innerRadius,
        startAngle
  ...
  fitSectorInRect: function (width, height, startAngle, lengthAngle, ratio) {
    ...
    var me = this,
      ...
      sameAngles =
        cache.startAngle === startAngle && cache.lengthAngle === lengthAngle;
    ...
    var sectorWidth = maxX - minX,
      ...
      sectorRegion = new Ext.util.Region(
        minY * scale,
        maxX * scale,
        maxY * scale,
        minX * scale
   ...
   * @private
   */
  fitSectorInPaddedRect: function (
    width,
    height,
    padding,
    startAngle,
