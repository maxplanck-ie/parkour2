describe("Ext.draw.sprite.Sprite", function () {
    ...
    describe("default centers of scaling and rotation", function () {
      it("should apply transformation in the following order: scale, rotate, translate", function () {
        ...
        var referenceMatrix = [
          ...
          -sin * sy,
          cos * sy,
          cos * (centerX * (1 - sx) - centerX) -
            sin * (centerY * (1 - sy) - centerY) +
            centerX +
            tx,
    ...
    describe("custom centers of scaling and rotation", function () {
      it("should apply transformation in the following order: scale, rotate, translate", function () {
        ...
        var referenceMatrix = [
          ...
          -sin * sy,
          cos * sy,
          cos * (scalingCenterX * (1 - sx) - rotationCenterX) -
            sin * (scalingCenterY * (1 - sy) - rotationCenterY) +
            rotationCenterX +
            tx,
  ...
  describe("hitTest", function () {
    ...
    it(
      "should return an object with the 'sprite' property set to the sprite itself, " +
        "if the sprite is visible and its bounding box is hit",
      function () {
