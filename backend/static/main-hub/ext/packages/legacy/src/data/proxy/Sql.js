...
Ext.define("Ext.data.proxy.Sql", {
    ...
    if (params.idOnly) {
        ...
        for (i = 0; i < len; i++) {
          ...
          if (property !== null) {
            ...
            if (operator === "in" || operator === "notin") {
              ...
              placeholder =
                "(" + Ext.String.repeat("?", value.length, ",") + ")";
      ...
      if (len) {
        for (i = 0; i < len; i++) {
          ...
          if (property !== null) {
            sql +=
              sortStatement + '"' + property + '" ' + sorter.getDirection();
            sortStatement = ", ";
          }
        }
      }
  ...
  privates: {
    ...
    executeTransaction: function (runner, failure, success, autoCreateTable) {
      ...
      me.getDatabaseObject().transaction(
        runner
          ? function (transaction) {
