    ...
    describe("name", function () {
      ...
      describe("configuration", function () {
        it("should add the name attribute to the inputEl", function () {
          ...
          render();
          expect(
            field.getComponent().inputElement.getAttribute("name")
          ).toEqual("myname");
        });
      });
    ...
    describe("tabIndex", function () {
      ...
      describe("configuration", function () {
        it("should add the tabindex attribute to the inputEl", function () {
          ...
          render();
          expect(
            field.getComponent().inputElement.getAttribute("tabindex")
          ).toEqual("10");
        });
      });
    ...
    describe("maxLength", function () {
      ...
      describe("configuration", function () {
        it("should add the maxlength attribute to the inputEl", function () {
          ...
          render();
          expect(
            field.getComponent().inputElement.getAttribute("maxlength")
          ).toEqual("10");
        });
      });
    ...
    describe("placeHolder", function () {
      ...
      describe("configuration", function () {
        it("should add the placeholder attribute to the inputEl", function () {
          ...
          render();
          expect(
            field.getComponent().inputElement.getAttribute("placeholder")
          ).toEqual("testing");
        });
      });
      ...
      describe("using value 'on'", function () {
        ...
        describe("configuration", function () {
          it("should add the autocomplete attribute to the inputEl", function () {
            ...
            render();
            expect(
              field.getComponent().inputElement.getAttribute("autocomplete")
            ).toEqual("on");
          });
        });
      ...
      describe("using value 'on'", function () {
        ...
        describe("configuration", function () {
          it("should add the autocapitalize attribute to the inputEl", function () {
            ...
            render();
            expect(
              field.getComponent().inputElement.getAttribute("autocapitalize")
            ).toEqual("on");
          });
        });
      ...
      describe("using value 'on'", function () {
        ...
        describe("configuration", function () {
          it("should add the autocorrect attribute to the inputEl", function () {
            ...
            render();
            expect(
              field.getComponent().inputElement.getAttribute("autocorrect")
            ).toEqual("on");
          });
        });
