  ...
  describe("load", function () {
    describe("direct", function () {
      ...
      it("should throw an exception if load fn cannot be resolved", function () {
        ...
        var ex =
          "Cannot resolve Direct API method 'bumble.zingbong' for load action in Ext.form.Panel instance with id:";
    ...
    describe("direct", function () {
      ...
      describe("function resolution", function () {
        ...
        it("should throw an exception if function cannot be resolved", function () {
          ...
          var ex =
            "Cannot resolve Direct API method 'foo.blerg' for submit action in Ext.form.Panel instance with id:";
