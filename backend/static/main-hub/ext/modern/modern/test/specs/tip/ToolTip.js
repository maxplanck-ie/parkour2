...
describe("Ext.tip.ToolTip", function () {
  ...
  describe("show/hide", function () {
    ...
    itDesktop(
      "should hide the tooltip after mousing out of the target element",
      function () {
        runs(function () {
  ...
  describe("anchorToTarget=false", function () {
    ...
    it("should allow anchoring the right of the tooltip to the mouse pointer", function () {
      ...
      runs(function () {
        expect(tip.el).toBePositionedAt(
          xy[0] - 15 - tip.el.getWidth() - tip.anchorSize.y,
          xy[1] - tip.getHeight() / 2
        );
      });
    });
    ...
    it("should allow anchoring the bottom of the tooltip to the mouse pointer", function () {
      ...
      runs(function () {
        expect(tip.el).toBePositionedAt(
          xy[0] - tip.el.getWidth() / 2,
          xy[1] - 18 - tip.el.getHeight() - tip.anchorSize.y
        );
      });
    });
