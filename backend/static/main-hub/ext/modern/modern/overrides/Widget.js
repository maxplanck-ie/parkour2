...
Ext.define(
  "Ext.overrides.Widget",
  {
    ...
    requires: ["Ext.behavior.Translatable"],
    ...
    toFront: function (/* private */ fromMousedown) {
      ...
      if (
        !me.hasListeners.beforetofront ||
        me.fireEvent("beforetofront", me) !== false
      ) {
    ...
    getAlignRegion: function (component, alignment, options) {
      ...
      return me.el.getRegion().alignTo(
        Ext.apply(
          {
