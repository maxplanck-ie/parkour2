...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='library',
            name='measuring_unit',
            field=models.CharField(blank=True, choices=[('concentration', 'Concentration (ng/µl)'), ('-', 'Unknown')], max_length=50, null=True, verbose_name='Measuring Unit'),
        ),
        migrations.AddField(
            model_name='library',
            name='measuring_unit_facility',
            field=models.CharField(blank=True, choices=[('concentration', 'Concentration (ng/µl)'), ('-', 'Unknown')], max_length=50, null=True, verbose_name='Measuring Unit (facility)'),
        ),
        migrations.AddField(
            model_name='library',
            name='percent_total',
