...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='sample',
            name='measuring_unit',
            field=models.CharField(blank=True, choices=[('ng/µl', 'ng/µl (Concentration)'), ('M', 'M (Cells)'), ('-', 'Unknown')], max_length=50, null=True, verbose_name='Measuring Unit'),
        ),
        migrations.AddField(
            model_name='sample',
            name='measuring_unit_facility',
            field=models.CharField(blank=True, choices=[('ng/µl', 'ng/µl (Concentration)'), ('M', 'M (Cells)'), ('-', 'Unknown')], max_length=50, null=True, verbose_name='Measuring Unit (facility)'),
        ),
        migrations.AddField(
            model_name='sample',
            name='volume',
