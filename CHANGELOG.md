...
- Duties: migrated the legacy AG Grid to the shared Vue/Tabulator table, retaining inline editing, date-period filtering, and per-column filters; added Playwright coverage for add/search/period-filter/inline-edit.
