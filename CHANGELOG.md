...
- Dev deployments now have an integrated tool available for generating, saving, and running SQL queries: [SQL Explorer](sqlexplorer.io)  (use: `make enable-explorer` to activate, and then navigate to `<URL>/explorer`.)
