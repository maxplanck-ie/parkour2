...
- Removed unused legacy static assets (DataTables, jQuery, noty, daterangepicker, underscore, Bootstrap 3, glyphicon fonts) that had no remaining references anywhere in the app; server-rendered pages (login, password reset, error pages) now use Bootstrap 5 instead of Bootstrap 3. No user-visible change other than faster page loads. (Direct commits `e8486908`, `7de9b0a0`, `794c158a`.)
