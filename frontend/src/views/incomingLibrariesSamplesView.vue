        ...
        <div class="popup-body">
          ...
          <div class="export-section" style="height: 100%">
            ...
            <div class="file-list-section">
              ...
              <div v-for="(file, index) in fetchedIncomingLibrariesAndSamplesTemplates" :key="index" class="file-item">
                <div class="file-info">
                  <svg style="display: block" fill="none" width="24px" height="24px" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <g>
  ...
  methods: {
    ...
    async downloadExportTemplate(file) {
      try {
        ...
        link.href = url;
        link.setAttribute("download", file.name || "IncomingLibrariesAndSamples.xlsx");
