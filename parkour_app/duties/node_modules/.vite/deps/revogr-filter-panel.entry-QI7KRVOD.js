...
var __awaiter, __generator, RevoButton, filterStyleCss, defaultType, FILTER_LIST_CLASS, FILTER_LIST_CLASS_ACTION, FilterPanel;
var init_revogr_filter_panel_entry = __esm({
  "node_modules/@revolist/revogrid/dist/esm-es5/revogr-filter-panel.entry.js"() {
    init_index_6f753b3c();
    init_debounce_e4e6dd45();
    __awaiter = function(e2, t, i, r) {
      function n(e3) {
        return e3 instanceof i ? e3 : new i(function(t2) {
          t2(e3);
        });
      }
      return new (i || (i = Promise))(function(i2, o) {
        ...
        function a(e3) {
          e3.done ? i2(e3.value) : n(e3.value).then(s, l);
        }
        a((r = r.apply(e2, t || [])).next());
      });
    };
    __generator = function(e2, t) {
      ...
      function a(s2) {
        ...
        while (i)
          try {
            if (r = 1, n && (o = s2[0] & 2 ? n["return"] : s2[0] ? n["throw"] || ((o = n["return"]) && o.call(n), 0) : n.next) && !(o = o.call(n, s2[1])).done)
              return o;
            if (n = 0, o)
              s2 = [s2[0] & 2, o.value];
            switch (s2[0]) {
    ...
    RevoButton = function(e2, t) {
      var i, r;
      return h("button", Object.assign({}, e2, { class: Object.assign(Object.assign({}, typeof e2.class === "object" ? e2.class : e2.class ? (i = {}, i[e2.class] = true, i) : ""), (r = {}, r["revo-button"] = true, r)) }), t);
    };
    (function e() {
      ...
      if (!Element.prototype.closest) {
        Element.prototype.closest = function(e2) {
          var t = this;
          do {
            if (Element.prototype.matches.call(t, e2)) {
              return t;
            }
    ...
    FilterPanel = function() {
      function e2(e3) {
        ...
        this.debouncedApplyFilter = debounce_1(function() {
          t.filterChange.emit(t.filterItems);
        }, 400);
      }
      e2.prototype.onMouseDown = function(e3) {
        if (this.changes && !e3.defaultPrevented) {
          var t = e3.target;
          if (this.isOutside(t) && !isFilterBtn(t)) {
            this.changes = void 0;
          }
        }
      };
      e2.prototype.show = function(e3) {
      ...
      e2.prototype.getChanges = function() {
        return __awaiter(this, void 0, void 0, function() {
          return __generator(this, function(e3) {
            return [2, this.changes];
          });
        });
      };
      e2.prototype.componentWillRender = function() {
        if (!this.isFilterIdSet) {
          this.isFilterIdSet = true;
          var e3 = Object.keys(this.filterItems);
          for (var t = 0, i = e3; t < i.length; t++) {
            var r = i[t];
            this.filterId += this.filterItems[r].length;
          }
        }
      };
      e2.prototype.renderSelectOptions = function(e3, t) {
        var i = this;
        if (t === void 0) {
          t = false;
        }
        var r;
        var n = [];
        var o = (r = this.changes) === null || r === void 0 ? void 0 : r.prop;
        if (!t) {
          n.push(h("option", { selected: this.currentFilterType === defaultType, value: defaultType }, o && this.filterItems[o] && this.filterItems[o].length > 0 ? "Add more condition..." : this.filterNames[defaultType]));
        }
        for (var s in this.filterTypes) {
          n.push.apply(n, this.filterTypes[s].map(function(t2) {
            return h("option", { value: t2, selected: e3 === t2 }, i.filterNames[t2]);
          }));
          n.push(h("option", { disabled: true }));
        }
        return n;
      };
      e2.prototype.renderExtra = function(e3, t) {
        var i = this;
        var r = this.filterItems[e3];
        if (!r)
          return "";
        if (this.filterEntities[r[t].type].extra !== "input")
          return "";
        return h("input", { id: "filter-input-".concat(r[t].id), placeholder: "Enter value...", type: "text", value: r[t].value, onInput: this.onUserInput.bind(this, t, e3), onKeyDown: function(e4) {
          return i.onKeyDown(e4);
        } });
      };
      e2.prototype.getFilterItemsList = function() {
        var e3 = this;
        var t;
        var i = (t = this.changes) === null || t === void 0 ? void 0 : t.prop;
        if (!(i || i === 0))
          return "";
        var r = this.filterItems[i] || [];
        return h("div", { key: this.filterId }, r.map(function(t2, r2) {
          var n;
          if (r2 !== e3.filterItems[i].length - 1) {
            n = h("div", { onClick: function() {
              return e3.toggleFilterAndOr(t2.id);
            } }, h(AndOrButton, { isAnd: t2.relation === "and" }));
          }
          return h("div", { key: t2.id, class: FILTER_LIST_CLASS }, h("div", { class: { "select-input": true } }, h("select", { class: "select-css select-filter", onChange: function(t3) {
            return e3.onFilterTypeChange(t3, i, r2);
          } }, e3.renderSelectOptions(e3.filterItems[i][r2].type, true)), h("div", { class: FILTER_LIST_CLASS_ACTION }, n), h("div", { onClick: function() {
            return e3.onRemoveFilter(t2.id);
          } }, h(TrashButton, null))), h("div", null, e3.renderExtra(i, r2)));
        }), r.length > 0 ? h("div", { class: "add-filter-divider" }) : "");
      };
      e2.prototype.render = function() {
        ...
        var t = { display: "block", left: "".concat(this.changes.x, "px"), top: "".concat(this.changes.y, "px") };
        var i = Object.assign(this.filterCaptionsInternal, this.filterCaptions);
        return h(Host, { style: t }, h("label", null, i.title), h("div", { class: "filter-holder" }, this.getFilterItemsList()), h("div", { class: "add-filter" }, h("select", { id: "add-filter", class: "select-css", onChange: function(t2) {
          return e3.onAddNewFilter(t2);
        } }, this.renderSelectOptions(this.currentFilterType))), h("div", { class: "filter-actions" }, this.disableDynamicFiltering && h(RevoButton, { class: { red: true, save: true }, onClick: function() {
          return e3.onSave();
        } }, i.save), h(RevoButton, { class: { red: true, reset: true }, onClick: function() {
          return e3.onReset();
        } }, i.reset), h(RevoButton, { class: { light: true, cancel: true }, onClick: function() {
          return e3.onCancel();
        } }, i.cancel)));
      };
      e2.prototype.onFilterTypeChange = function(e3, t, i) {
        var r = this;
        var n = e3.target;
        var o = n.value;
        this.filterItems[t][i].type = o;
        this.filterId++;
        setTimeout(function() {
          var e4 = document.getElementById("filter-input-" + r.filterItems[t][i].id);
          if (e4)
            e4.focus();
        }, 0);
      ...
      e2.prototype.onAddNewFilter = function(e3) {
        var t = e3.target;
        var i = t.value;
        this.currentFilterType = i;
        this.addNewFilterToProp();
        var r = document.getElementById("add-filter");
        if (r) {
          r.value = defaultType;
          this.currentFilterType = defaultType;
        }
      ...
      e2.prototype.addNewFilterToProp = function() {
        var e3 = this;
        var t;
        var i = (t = this.changes) === null || t === void 0 ? void 0 : t.prop;
        if (!(i || i === 0))
          return;
        if (!this.filterItems[i]) {
          this.filterItems[i] = [];
        }
        ...
        this.filterItems[i].push({ id: this.currentFilterId, type: this.currentFilterType, value: "", relation: "and" });
        setTimeout(function() {
          var t2 = document.getElementById("filter-input-" + e3.currentFilterId);
          if (t2)
            t2.focus();
        }, 0);
      };
      e2.prototype.onUserInput = function(e3, t, i) {
        this.filterItems[t][e3].value = i.target.value;
        if (!this.disableDynamicFiltering)
          this.debouncedApplyFilter();
      };
      e2.prototype.onKeyDown = function(e3) {
        if (e3.key.toLowerCase() === "enter") {
          var t = document.getElementById("add-filter");
          if (t) {
            t.value = defaultType;
            this.currentFilterType = defaultType;
            this.addNewFilterToProp();
      ...
      e2.prototype.onRemoveFilter = function(e3) {
        this.assertChanges();
        this.filterId++;
        var t = this.changes.prop;
        var i = this.filterItems[t];
        if (!i)
          return;
        var r = i.findIndex(function(t2) {
          return t2.id === e3;
        });
        if (r === -1)
          return;
        i.splice(r, 1);
        if (i.length === 0)
          delete this.filterItems[t];
        if (!this.disableDynamicFiltering)
          this.debouncedApplyFilter();
      };
      e2.prototype.toggleFilterAndOr = function(e3) {
        this.assertChanges();
        this.filterId++;
        var t = this.changes.prop;
        var i = this.filterItems[t];
        ...
        if (r === -1)
          return;
        i[r].relation = i[r].relation === "and" ? "or" : "and";
        if (!this.disableDynamicFiltering)
          this.debouncedApplyFilter();
      };
      e2.prototype.assertChanges = function() {
        if (!this.changes) {
          throw new Error("Changes required per edit");
        }
      };
      e2.prototype.isOutside = function(e3) {
        var t = document.getElementById("add-filter");
        if (t)
          t.value = defaultType;
        this.currentFilterType = defaultType;
        ...
        this.currentFilterId = -1;
        if (e3.classList.contains('[uuid="'.concat(this.uuid, '"]'))) {
          return false;
        }
        return !(e3 === null || e3 === void 0 ? void 0 : e3.closest('[uuid="'.concat(this.uuid, '"]')));
      };
      return e2;
    }();
...
init_revogr_filter_panel_entry();
export {
  FilterPanel as revogr_filter_panel
};
/*! Bundled license information:

@revolist/revogrid/dist/esm-es5/revogr-filter-panel.entry.js:
  (*!
   * Built by Revolist
   *)
*/
//# sourceMappingURL=revogr-filter-panel.entry-QI7KRVOD.js.map
