...
// node_modules/@revolist/revogrid/dist/esm/polyfills/index.js
...
// node_modules/@revolist/revogrid/dist/esm-es5/loader.js
  ...
  "node_modules/@revolist/revogrid/dist/esm-es5/loader.js"() {
    ...
    patchEsm = function() {
      if (!(CSS && CSS.supports && CSS.supports("color", "var(--c)"))) {
        return import("./css-shim-e1e1ea5e-JQPPMW6U.js").then(function() {
...
// node_modules/@revolist/vue3-datagrid/dist/vgrid.js
var require_vgrid = __commonJS({
  "node_modules/@revolist/vue3-datagrid/dist/vgrid.js"(exports, module) {
    !function(e, t) {
      "object" == typeof exports && "object" == typeof module ? module.exports = t(require_vue(), (init_loader2(), __toCommonJS(loader_exports))) : "function" == typeof define && define.amd ? define("VGrid", ["vue", "@revolist/revogrid/loader"], t) : "object" == typeof exports ? exports.VGrid = t(require_vue(), (init_loader2(), __toCommonJS(loader_exports))) : e.VGrid = t(e.vue, e["@revolist/revogrid/loader"]);
    }(self, (e, t) => (() => {
      "use strict";
      var r = { 829: (e2) => {
        e2.exports = t;
      ...
      function n(e2) {
        ...
        if (void 0 !== t2)
          return t2.exports;
        var s2 = o[e2] = { exports: {} };
        return r[e2](s2, s2.exports, n), s2.exports;
      }
      n.d = (e2, t2) => {
        for (var r2 in t2)
      ...
      var s = {};
      return (() => {
        n.r(s), n.d(s, { VGrid: () => v, VGridPlugin: () => b, VGridVueEditor: () => y, VGridVueTemplate: () => g, VGridVueTemplateConstructor: () => h, default: () => C });
        var e2 = n(748);
        const t2 = "update:modelValue", r2 = "modelValue", o2 = "navManager", i = Symbol(), a = { default: i }, l = (e3) => (null == e3 ? void 0 : e3.split(" ")) || [], u = (e3, t3, r3 = []) => {
          var o3;
          return [...Array.from((null === (o3 = e3.value) || void 0 === o3 ? void 0 : o3.classList) || []), ...r3].filter((e4, r4, o4) => !t3.has(e4) && o4.indexOf(e4) === r4);
        }, d = ((n2, s2, d2 = [], c2, f2, p2) => {
          void 0 !== s2 && s2();
          const v2 = (0, e2.defineComponent)((s3, { attrs: a2, slots: d3, emit: v3 }) => {
            var m2;
            let b2 = s3[c2];
            const g2 = (0, e2.ref)(), h2 = new Set(l(a2.class)), y2 = (e3) => {
              e3.el && (Array.isArray(f2) ? f2 : [f2]).forEach((r3) => {
                e3.el.addEventListener(r3.toLowerCase(), (e4) => {
                  b2 = (null == e4 ? void 0 : e4.target)[c2], v3(t2, b2), p2 && v3(p2, e4);
                });
              });
            }, C2 = (0, e2.getCurrentInstance)(), x = (null === (m2 = null == C2 ? void 0 : C2.appContext) || void 0 === m2 ? void 0 : m2.provides[o2]) ? (0, e2.inject)(o2) : void 0;
            return () => {
              b2 = s3[c2], l(a2.class).forEach((e3) => {
                h2.add(e3);
              });
              const t3 = s3.onClick;
              let o3 = { ref: g2, class: u(g2, h2), onClick: (e3) => {
                void 0 !== t3 && t3(e3), e3.defaultPrevented || ((e4) => {
                  const { routerLink: t4 } = s3;
                  if (t4 !== i)
                    if (void 0 !== x) {
                      let t5 = { event: e4 };
                      for (const e5 in s3) {
                        const r3 = s3[e5];
                        s3.hasOwnProperty(e5) && e5.startsWith("router") && r3 !== i && (t5[e5] = r3);
                      }
                      x.navigate(t5);
                    } else
                      console.warn("Tried to navigate, but no router was found. Make sure you have mounted Vue Router.");
                })(e3);
              }, onVnodeBeforeMount: f2 ? y2 : void 0 };
              for (const e3 in s3) {
                const t4 = s3[e3];
                (s3.hasOwnProperty(e3) && t4 !== i || e3.startsWith("aria")) && (o3[e3] = t4);
              }
              return c2 && (s3[r2] !== i ? o3 = Object.assign(Object.assign({}, o3), { [c2]: s3[r2] }) : b2 !== i && (o3 = Object.assign(Object.assign({}, o3), { [c2]: b2 }))), (0, e2.h)(n2, o3, d3.default && d3.default());
            };
          });
          return "function" != typeof v2 && (v2.name = n2, v2.props = { routerLink: a }, d2.forEach((e3) => {
            v2.props[e3] = a;
          }), c2 && (v2.props[r2] = a, v2.emits = [t2, p2])), v2;
        })("revo-grid", void 0, ["rowHeaders", "frameSize", "rowSize", "colSize", "range", "readonly", "resize", "canFocus", "useClipboard", "columns", "source", "pinnedTopSource", "pinnedBottomSource", "rowDefinitions", "editors", "plugins", "columnTypes", "theme", "rowClass", "autoSizeColumn", "filter", "canMoveColumns", "trimmedRows", "exporting", "grouping", "stretch", "beforeedit", "beforerangeedit", "afteredit", "beforeautofill", "beforeaange", "afterfocus", "roworderchanged", "beforesourcesortingapply", "beforesortingapply", "beforesorting", "rowdragstart", "headerclick", "beforecellfocus", "beforefocuslost", "beforesourceset", "aftersourceset", "beforecolumnsset", "beforecolumnapplied", "aftercolumnsset", "beforefilterapply", "beforefiltertrimmed", "beforetrimmed", "aftertrimmed", "viewportscroll", "beforeexport", "beforeeditstart", "aftercolumnresize"]), c = (t3, r3, o3, n2) => {
          if (!r3)
            return null;
          let s2 = r3._vnode;
          if (s2) {
            n2 && (s2.appContext = n2);
            for (const e3 in o3)
              s2.component.props[e3] = o3[e3];
          } else
            s2 = (0, e2.createVNode)(t3, o3), n2 && (s2.appContext = n2), (0, e2.render)(s2, r3);
          return { vueInstance: s2, destroy: () => (0, e2.render)(null, r3), el: r3 };
        };
        class f {
          constructor(e3, t3, r3, o3, n2) {
            this.VueEditorConstructor = e3, this.column = t3, this.save = r3, this.close = o3, this.appContext = n2, this.element = null, this.editCell = null;
          }
          componentDidRender() {
          }
          ...
          render(e3) {
            return e3("span", { ref: (e4) => {
              this.vueEl = c(this.VueEditorConstructor, e4, Object.assign(Object.assign({}, this.editCell), { column: this.column, save: this.save, close: this.close }), this.appContext);
            } });
          }
        }
        const p = (0, n(829).defineCustomElements)(), v = (0, e2.defineAsyncComponent)(async () => (await p, d));
        let m = false;
        const b = { async install(e3) {
          await p, m || (m = true, e3.component("vue-data-grid", v));
        } }, g = (t3) => {
          const r3 = (0, e2.getCurrentInstance)(), o3 = null == r3 ? void 0 : r3.appContext;
          return (e3, r4) => e3("span", { ref: (e4) => c(t3, e4, r4, o3) });
        }, h = c, y = (t3) => {
          const r3 = (0, e2.getCurrentInstance)(), o3 = null == r3 ? void 0 : r3.appContext;
          return function(e3, r4, n2) {
            return new f(t3, e3, r4, n2, o3);
          };
        }, C = v;
      })(), s;
    })());
...
export default require_vgrid();
/*! Bundled license information:

@revolist/revogrid/dist/esm-es5/loader.js:
  (*!
   * Built by Revolist
   *)
...
@revolist/revogrid/loader/index.js:
   ...
   *)
*/
//# sourceMappingURL=@revolist_vue3-datagrid.js.map
