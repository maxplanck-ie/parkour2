...
def test_login_page(page: Page):
    ...
    forgotPasswordEmailSubmitButton = page.get_by_role("button", name="Reset my password")

    utilities.visit_login_page(page)
    expect(page.locator("h2.form-signin-heading")).to_have_text(re.compile(r"Parkour [0-9][0-9]\.[0-9][0-9]\.[0-9][0-9]"))
    ...
    expect(page.get_by_text("We’ve emailed you instructions for setting your password")).to_be_visible()
    utilities.visit_login_page(page)
