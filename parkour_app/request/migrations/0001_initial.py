            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="request", to="request.FileRequest"
                    ),
                ),
                (
                    "libraries",
                    models.ManyToManyField(
                        blank=True, related_name="request", to="library.Library"
                    ),
                ),
                (
                    "samples",
                    models.ManyToManyField(
                        blank=True, related_name="request", to="sample.Sample"
                    ),
                ),
                (
                    "user",
                    models.ForeignKey(
                        on_delete=models.SET(request.models.get_sentinel_user),
