                ...
                items: [
                  {
                    xtype: 'numberfield',
                    name: 'read1_cycles',
                    fieldLabel: '<span data-qtip="Read 1 cycles">R1</span>',
                    labelWidth: 20,
                    width: 115,
                    value: 1,
                    minValue: 1
                  },
                  {
                    xtype: 'numberfield',
                    name: 'read2_cycles',
                    fieldLabel: '<span data-qtip="Read 2 cycles">R2</span>',
                    labelWidth: 20,
                    width: 115,
                    padding: "0 0 0 10px",
                    value: 0
                ...
                items: [
                  {
                    xtype: 'numberfield',
                    name: 'index1_cycles',
                    fieldLabel: '<span data-qtip="Index 1 cycles">I1</span>',
                    labelWidth: 20,
                    width: 115,
                    value: 0,
                    maxValue: 10
                  },
                  {
                    xtype: 'numberfield',
                    name: 'index2_cycles',
                    fieldLabel: '<span data-qtip="Index 2 cycles">I2</span>',
                    labelWidth: 20,
                    width: 115,
                    padding: "0 0 0 10px",
                    value: 0,
